                        ...
                        <TouchableWithoutFeedback>
                            <View className='bg-white p-5 mb-2 rounded-3xl items-center w-full h-2/6 top-5 shadow-2xl shadow-green-800'>
                                ...
                                <View className='flex-row justify-between'>
                                    <Button className='w-2/5 h-2/5 my-8 mx-5 rounded-full items-center justify-center bg-neutral-100' textColor='#41525C'  mode="contained" style={[Fonts.buttonTitle]} onPress={close}>REGRESAR</Button>
                                    <Button className='w-2/5 h-2/5 my-8 mx-5 rounded-full items-center justify-center' mode="contained" style={[Fonts.buttonTitle, {backgroundColor: '#41525C'}]} onPress={onPress}>{button}</Button>
                                </View>
                            </View>
                        </TouchableWithoutFeedback>
                    </View>
