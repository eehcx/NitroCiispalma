...
export default InputText = ({ placeholder, value, onChange, label, backgroundColor, marginRight, marginLeft }) => {
    ...
    return (
        <>
            ...
            <TextInput style={[InputForms.input, { marginBottom: 30 }, { height: 41, paddingLeft: 25, borderRadius: 17, backgroundColor: backgroundColor }]} placeholder={placeholder} value={value} onChangeText={onChange} />
        </>
    );
};