...
export default MainBarScreen = () => {
    ...
    return (
        <Tab.Navigator screenOptions={{ headerShown: false, tabBarActiveTintColor: '#333', tabBarInactiveTintColor: '#ccc', tabBarStyle: { display: 'flex', backgroundColor: '#f5f5f5', paddingVertical: 15, elevation: 0, height:70,  elevation: 0, shadowOpacity: 0 } }} >
